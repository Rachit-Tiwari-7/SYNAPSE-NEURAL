...
const DEFAULT_VAPI_KEY = process.env.NEXT_PUBLIC_VAPI_PUBLIC_KEY || '4a4ffbd2-f0af-4012-81e4-c38ed7a3edbb';
const DEFAULT_VAPI_ID = process.env.NEXT_PUBLIC_VAPI_ASSISTANT_ID || 'f82da78c-80cd-43bc-bf63-de17abbceed4';
